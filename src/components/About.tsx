        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative glass-strong p-6 rounded-3xl">
                <Avatar className="w-64 h-64 mx-auto border-4 border-primary/30">
                  <AvatarImage 
                    src="https://res.cloudinary.com/doqef8351/image/upload/v1755331306/WhatsApp_Image_2025-08-16_at_13.30.24_muenhe.jpg" 
                    alt="SARATH BRAHMA SAI NAYAK BANAVATH"
                    className="object-cover"
                  />
                  <AvatarFallback className="text-6xl bg-gradient-neon text-background">SAI</AvatarFallback>
                </Avatar>
                
                {/* Floating Stats */}
                <div className="absolute -top-4 -right-4 glass px-4 py-2 rounded-lg border-gradient">
                  <span className="text-sm gradient-text font-semibold">1+ Years</span>
                </div>
                <div className="absolute -bottom-4 -left-4 glass px-4 py-2 rounded-lg border-gradient">
                  <span className="text-sm gradient-text font-semibold">10+ Projects</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p className="text-lg">
                I'm a Full Stack Developer with over 1 years of experience building 
            ...
            <div className="glass p-6 rounded-xl">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>🚀 Built my first website at age 18</li>
